...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/oryctolagus_cuniculus/dna"
FASTA_GZ="Oryctolagus_cuniculus.OryCun2.0.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/oryctolagus_cuniculus"
GTF_GZ="Oryctolagus_cuniculus.OryCun2.0.99.gtf.gz"
WGET_GTF_GZ=1
