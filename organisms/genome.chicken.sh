...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/gallus_gallus/dna"
FASTA_GZ="Gallus_gallus.GRCg6a.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/gallus_gallus"
GTF_GZ="Gallus_gallus.GRCg6a.99.gtf.gz"
WGET_GTF_GZ=1
