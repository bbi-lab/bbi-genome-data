...
#
ENSEMBL_DNA_URL="ftp://ftp.ensemblgenomes.org/pub/plants/release-46/fasta/zea_mays/dna"
FASTA_GZ="Zea_mays.B73_RefGen_v4.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensemblgenomes.org/pub/plants/release-46/gtf/zea_mays"
GTF_GZ="Zea_mays.B73_RefGen_v4.46.gtf.gz"
WGET_GTF_GZ=1
