...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/drosophila_melanogaster/dna"
FASTA_GZ="Drosophila_melanogaster.BDGP6.28.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/drosophila_melanogaster"
GTF_GZ="Drosophila_melanogaster.BDGP6.28.99.gtf.gz"
WGET_GTF_GZ=1
