...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/notechis_scutatus/dna"
FASTA_GZ="Notechis_scutatus.TS10Xv2-PRI.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/notechis_scutatus"
GTF_GZ="Notechis_scutatus.TS10Xv2-PRI.99.gtf.gz"
WGET_GTF_GZ=1
