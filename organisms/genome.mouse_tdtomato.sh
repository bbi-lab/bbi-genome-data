...
GROUP="mouse_tdtomato"
ORGANISM="mouse_tdtomato"

ENSEMBL_DNA_URL="/net/bbi/vol1/data/genomes_stage/mouse_tdtomato/source_mouse_tdtomato"
FASTA_GZ="Mus_musculus_tdtomato.GRCm38.dna.toplevel.fa.gz"
WGET_FASTA_GZ=0

ENSEMBL_GTF_URL="/net/bbi/vol1/data/genomes_stage/mouse_tdtomato/source_mouse_tdtomato"
GTF_GZ="Mus_musculus_tdtomato.GRCm38.99.gtf.gz"
WGET_GTF_GZ=0
