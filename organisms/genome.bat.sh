...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/pteropus_vampyrus/dna"
FASTA_GZ="Pteropus_vampyrus.pteVam1.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/pteropus_vampyrus"
GTF_GZ="Pteropus_vampyrus.pteVam1.99.gtf.gz"
WGET_GTF_GZ=1
