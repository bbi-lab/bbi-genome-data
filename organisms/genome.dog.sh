...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/canis_familiaris/dna"
FASTA_GZ="Canis_familiaris.CanFam3.1.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/canis_familiaris"
GTF_GZ="Canis_familiaris.CanFam3.1.99.gtf.gz"
WGET_GTF_GZ=1
