...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/rattus_norvegicus/dna"
FASTA_GZ="Rattus_norvegicus.Rnor_6.0.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/rattus_norvegicus"
GTF_GZ="Rattus_norvegicus.Rnor_6.0.99.gtf.gz"
WGET_GTF_GZ=1
