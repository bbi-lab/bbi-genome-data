...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/monodelphis_domestica/dna"
FASTA_GZ="Monodelphis_domestica.ASM229v1.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/monodelphis_domestica"
GTF_GZ="Monodelphis_domestica.ASM229v1.99.gtf.gz"
WGET_GTF_GZ=1
