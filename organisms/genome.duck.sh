...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/anas_platyrhynchos_platyrhynchos/dna"
FASTA_GZ="Anas_platyrhynchos_platyrhynchos.CAU_duck1.0.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/anas_platyrhynchos_platyrhynchos"
GTF_GZ="Anas_platyrhynchos_platyrhynchos.CAU_duck1.0.99.gtf.gz"
WGET_GTF_GZ=1
