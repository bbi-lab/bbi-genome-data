...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/macaca_fascicularis/dna"
FASTA_GZ="Macaca_fascicularis.Macaca_fascicularis_5.0.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/macaca_fascicularis"
GTF_GZ="Macaca_fascicularis.Macaca_fascicularis_5.0.99.gtf.gz"
WGET_GTF_GZ=1
