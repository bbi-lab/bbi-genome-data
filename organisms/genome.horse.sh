...
#
ENSEMBL_DNA_URL="ftp://ftp.ensembl.org/pub/release-99/fasta/equus_caballus/dna"
FASTA_GZ="Equus_caballus.EquCab3.0.dna.toplevel.fa.gz"
WGET_FASTA_GZ=1
...
#
ENSEMBL_GTF_URL="ftp://ftp.ensembl.org/pub/release-99/gtf/equus_caballus"
GTF_GZ="Equus_caballus.EquCab3.0.99.gtf.gz"
WGET_GTF_GZ=1
